...
async function createSubname_default({
  ...
  if (labels.length === 1) {
    throw new Error("Subnames in ANS.js can only be created for 2LDs, not TLDs");
  }
  ...
  switch (contract) {
    ...
    case "nameWrapper": {
      ...
      const generatedFuses = "fuses" in wrapperArgs && wrapperArgs.fuses ? generateFuseInput(wrapperArgs.fuses) : "0";
