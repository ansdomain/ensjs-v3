        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    ;
                    return [4 /*yield*/, Promise.resolve(middleware(__assign(__assign({}, init), { url: url })))];
                case 1:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    (_b = _c.sent(), url = _b.url, init = __rest(_b, ["url"]));
                    _c.label = 2;
                case 2: return [4 /*yield*/, fetch(url + "?" + queryParams, init)];
                case 3: return [2 /*return*/, _c.sent()];
            }
        });
    });
...
var GraphQLClient = /** @class */ (function () {
    ...
    GraphQLClient.prototype.rawRequest = function (queryOrOptions, variables, requestHeaders) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                operationName = resolveRequestDocument_1.resolveRequestDocument(rawRequestOptions.query).operationName;
    ...
    GraphQLClient.prototype.request = function (documentOrOptions) {
        ...
        var _d = resolveRequestDocument_1.resolveRequestDocument(requestOptions.document), query = _d.query, operationName = _d.operationName;
        return makeRequest({
            url: url,
            query: query,
    ...
    GraphQLClient.prototype.batchRequests = function (documentsOrOptions, requestHeaders) {
        ...
        var queries = batchRequestOptions.documents.map(function (_a) {
            ...
            return resolveRequestDocument_1.resolveRequestDocument(document).query;
        });
