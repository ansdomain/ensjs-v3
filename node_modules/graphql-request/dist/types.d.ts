...
export declare type RequestMiddlware = (request: RequestExtendedInit) => RequestExtendedInit | Promise<RequestExtendedInit>;
declare type RequestExtendedInit = Dom.RequestInit & {
    url: string;
};
