...
export declare function decode<T = any>(data: ArrayBuffer | SharedArrayBuffer, tagger?: TaggedValueFunction, simpleValue?: SimpleValueFunction): T;
export declare function encode<T = any>(value: T): ArrayBuffer;
export {};
=======
/** A Function that extracts tagged values. */
declare type TaggedValueFunction = (value: any, tag: number) => TaggedValue;
